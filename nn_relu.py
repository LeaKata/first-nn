...
def network(x, weight, bias):
    ...
    first_layer = relu_layer(input_layer, w_0, b_0)
    second_layer = relu_layer(first_layer, w_1, b_1)
    out_layer = relu_layer(second_layer, w_2, b_2)
